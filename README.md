...
🚀 I enjoy building real-world applications that solve practical problems using AI.
...
AI-powered resume analysis with ATS score, skill extraction, resume feedback, and interview suggestions.

---

## 🛡️ OmniEye AI — Suspicious Activity Detection System

AI-powered real-time surveillance system for detecting suspicious activities using computer vision.

### Features

- 🎥 Webcam, CCTV & video analysis
- 🚨 Telegram alerts
- 🔫 Weapon detection
- 📄 CSV & PDF reports
...
`YOLOv8` • `MediaPipe` • `FastAPI` • `Python` • `OpenCV` • `WebSockets`
...
<p align="center">
<a href="https://www.linkedin.com/in/er-ashishkumar/">
